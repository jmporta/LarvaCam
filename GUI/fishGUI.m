...
handles.nSteps=3; % num of steps per block

%% Init and Set the Micro/Cam Environment

[handles.micro,handles.nDeviceNo,handles.nChildNo]=initConnections(handles.port);

% %% Run Experiment Test
% 
% % Set/Loading the step of the events
% disp('Loading events...');
% setEvents(micro);
%  
% % Record images (deviceNum,childNum,micro,expID,numSteps)
% record(nDeviceNo,nChildNo,micro,1,nSteps,1);
% 
% % close all
% closeConnections(nDeviceNo,micro);

%%% END INIT MAIN %%%
guidata(hObject,handles) % assign new parameters
...
function inputSteps_Callback(hObject, eventdata, handles)
% hObject    handle to inputSteps (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of inputSteps as text
%        str2double(get(hObject,'String')) returns contents of inputSteps as a double


% --- Executes during object creation, after setting all properties.
function inputSteps_CreateFcn(hObject, eventdata, handles)
% hObject    handle to inputSteps (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
nt = str2double(get(handles.inputSteps,'String'));
runExp(nt);
...
set(handles.uitableData,'data',zeros(val,handles.nColmn)); % Redifine the dimensions of the uitable
